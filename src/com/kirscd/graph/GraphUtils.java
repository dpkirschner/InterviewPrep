...
public class GraphUtils {
	 ...
	 * Returns a set of Nodes which have different relationships
	 */
	public static ArrayList<Node> buildWeightedGraph() {
		Node one = new Node("one");
		Node two = new Node("two");
		Node three = new Node ("three");
		Node four = new Node("four");
		...
		Edge oneTwo = new Edge(one, two, 1);
		Edge oneFive = new Edge(one, five, 6);
		Edge oneSix = new Edge(one, six, 2);
		
		Edge twoThree = new Edge(two, three, 4);
		Edge twoFive = new Edge(two, five, 2);
		
		Edge threeFour = new Edge(three, four, 3);
		
		Edge fourFive = new Edge(four, five, 1);
